...
class ModelConfig:
    ...
    # --- Paths (absolute paths on the remote GPU server) ---
    # NOTE: These paths are specific to your server environment.
    # Change them when deploying on a different machine.
    BASE_MODEL_PATH: str = "/root/autodl-tmp/finetune/finetune_qwen3-14b/models/Qwen3-14B"
    # Set to None to disable LoRA (and use base model only).
    LORA_WEIGHTS_PATH: Optional[str] = "/root/autodl-tmp/finetune/finetune_qwen3-14b/AndroSemLora"
